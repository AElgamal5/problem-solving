...
console.log(arraySign2([-1, -2, -3, -4, 3, 2, 1])); // 1
console.log(arraySign2([1, 5, 0, 2, -3])); // 0
console.log(arraySign2([-1, 1, -1, 1, -1])); // -1
console.log(
  arraySign2([
